...
WHERE category.name = '" . mysqli_real_escape_string($db_connection, $get_category) . "' AND lot . final_date > NOW() LIMIT " . $number_of_lots_by_page . " OFFSET " .
    $offset . ";";
...
$layout = include_template('all-lots_layout.php', ['categories' => $categories, 'user_name' => $user_name,
